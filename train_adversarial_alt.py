...
def main():
	...
	solver = CaptioningSolver(model, discrim, data, data, n_epochs=20, batch_size=64, gpu_list="1", update_rule='adam',
								learning_rate=0.0025, print_every=25, save_every=1, image_path='./image/',
